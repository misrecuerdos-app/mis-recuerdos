...
function updateInstallButtons() {
  document.querySelectorAll("[data-install-app]").forEach(button => {
    ...
    button.hidden = false;
    button.textContent = isIOSDevice() ? "Crear icono de acceso" : "Crear icono de acceso";
  });
}
...
function showInstallHelp(platform = "auto") {
  ...
  overlay.innerHTML = `
    ...
    <section class="install-help-card" role="dialog" aria-modal="true" aria-label="Crear icono de acceso">
      ...
      `}
      <p class="install-note">Es opcional. Mis Recuerdos también funciona directamente desde el navegador.</p>
