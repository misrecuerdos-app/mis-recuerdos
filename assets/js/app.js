...
const INFO_TOPICS = {
  ...
  install: {
    title: "Crear acceso en el celular",
    body: `
      ...
      <button class="info-install-button" data-install-app onclick="installRecuerdosApp()">Crear icono de acceso</button>
    `
  },
  guide: {
    title: "Cómo usarla",
      ...
      <section class="info-page">
        ...
        ` : `
          ...
          <div class="info-index">
            ...
            <button onclick="openInfoTopic('install')"><span>Crear acceso en el celular</span><b>›</b></button>
